...
object NetworkModule {
    ...
    @Singleton
    @Provides
    fun provideApiService(retrofit: Retrofit): IAppApi = retrofit.create(IAppApi::class.java)


    @Singleton
    @Provides
    fun providesRepository(apiService: IAppApi) = RemoteMobileUsageDataSource(apiService)
}